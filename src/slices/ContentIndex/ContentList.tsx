...
export default function ContentList({
  ...
  return (
    <div ref={component}>
      ...
      <div
        className="hover-reveal bg-over opacity-0f pointer-events-none absolute left-0 top-0 -z-10 h-[320px] w-[220px] rounded-lg bg-center transition-[background] duration-300"
        style={{
          backgroundImage:
