...
type BlogPostDocumentDataSlicesSlice = ImgBlockSlice | TextBlockSlice;
...
type ProjectDocumentDataSlicesSlice = ImgBlockSlice | TextBlockSlice;
...
interface SettingsDocumentData {
  ...
  /**
   * Linkend link field in *Settings*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.linkend_link
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  linkend_link: prismic.LinkField;
...
/**
 * Primary content in *ImgBlock → Primary*
 */
export interface ImgBlockSliceDefaultPrimary {
  /**
   * Image field in *ImgBlock → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: img_block.primary.image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
...
/**
 * Default variation for ImgBlock Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ImgBlockSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<ImgBlockSliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *ImgBlock*
 */
type ImgBlockSliceVariation = ImgBlockSliceDefault;

/**
 * ImgBlock Shared Slice
 *
 * - **API ID**: `img_block`
 * - **Description**: ImgBlock
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ImgBlockSlice = prismic.SharedSlice<
  "img_block",
  ImgBlockSliceVariation
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      HeroSliceDefault,
      ImgBlockSlice,
      ImgBlockSliceDefaultPrimary,
      ImgBlockSliceVariation,
      ImgBlockSliceDefault,
      TechStackSlice,
